...
func _enter_tree():
	...
	add_custom_type(
		"ProtonScatter", "Node3D", preload("./src/scatter.gd"), preload("./icons/scatter.svg")
	)
	add_custom_type(
		"ScatterItem", "Node3D", preload("./src/scatter_item.gd"), preload("./icons/item.svg")
	)
	add_custom_type(
		"ScatterShape", "Node3D", preload("./src/scatter_shape.gd"), preload("./icons/shape.svg")
	)
	add_custom_type(
		"ScatterCache",
		"Node3D",
